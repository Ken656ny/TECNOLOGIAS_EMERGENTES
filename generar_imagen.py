# generar_imagen.py @generar_imagen
...
from traductor import traductor  # Librería local para traducir un texto
...
def generar_imagen():
    ...
    2. Traduce el texto ingresado por el usuario del español a inglés.
